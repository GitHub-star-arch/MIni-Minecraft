...
var eimg,entity,bb,b,end=0,tb,ehea=300,bye;
function preload() {
...
function draw() {
    ...
    if(frameCount<200) {
        ...
        text("(Don't click on the finalsquare until you finished the dungeons. Otherwise this game is prone to lag.)",50,400)
        pop();
